...
export ZSH="/home/tuananh/.oh-my-zsh"
...
#Vhat launch
#alias vhat='java -jar /home/tuananh/Documents/Vhat_Application/Vhat.jar'
...
#launch bupsuite
alias burpsuite='/home/tuananh/Documents/Tools/BurpSuite/burp.sh'
...
# test ais
alias ais='python3 /home/tuananh/Documents/AIS/main.py'
...
export PATH="/home/tuananh/.pyenv/bin:$PATH"
eval "$(pyenv init -)"
...
#__conda_setup="$('/home/tuananh/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
#if [ $? -eq 0 ]; then
#    eval "$__conda_setup"
#else
#    if [ -f "/home/tuananh/miniconda3/etc/profile.d/conda.sh" ]; then
#        . "/home/tuananh/miniconda3/etc/profile.d/conda.sh"
#    else
#        export PATH="/home/tuananh/miniconda3/bin:$PATH"
#    fi
#fi
#unset __conda_setup
# <<< conda initialize <<<
